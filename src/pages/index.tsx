  ...
  return (
    <>
              ...
              <div className="statistics__content--details">
                <div className="statistics__data">
                  ...
                  <div className="statistics__data--title">
                    of vi-v2 members <b>significantly increase</b> reading frequency.
                  </div>
                </div>
                <div className="statistics__data">
                  <div className="statistics__data--number">96%</div>
                  <div className="statistics__data--title">
                    of vi-v2 members <b>establish better</b> habits.
                  </div>
                </div>
                <div className="statistics__data">
            ...
            <div className="statistics__wrapper">
              <div className="statistics__content--details statistics__content--details-second">
                <div className="statistics__data">
                  ...
                  <div className="statistics__data--title">
                    of vi-v2 members <b>report feeling more productive</b> after
                ...
                <div className="statistics__data">
                  ...
                  <div className="statistics__data--title">
                    of vi-v2 members have <b>noticed an improvement</b> in their
                ...
                <div className="statistics__data">
                  ...
                  <div className="statistics__data--title">
                    of vi-v2 members <b>feel more informed</b> about current
      ...
      <section id="numbers">
        <div className="container">
          <div className="row">
            <div className="section__title">Start growing with vi-v2 now</div>
            <div className="numbers__wrapper">
              ...
              <div className="numbers">
                ...
                <div className="numbers__sub--title">
                  Of vi-v2 members create a better reading habit
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="footer__top--wrapper">
              <div className="footer__block">
                ...
                <div>
                  <div className="footer__link--wrapper">
                    <a className="footer__link">vi-v2 Magazine</a>
                  </div>
                  <div className="footer__link--wrapper">
              ...
              <div className="footer__block">
                ...
                <div>
                  ...
                  <div className="footer__link--wrapper">
                    <a className="footer__link">vi-v2 Business</a>
                  </div>
                  <div className="footer__link--wrapper">
